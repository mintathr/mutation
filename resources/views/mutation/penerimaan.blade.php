...
<section class="content">
    <div class="card card-success">
        ...
        <form role="form" method="post" action="/mutation/penerimaan">
            @csrf
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control select2bs4" name="account_id" style="width: 100%;">
                        ...
                        <option value="{{ $other->id }}">{{ $other->name }} - {{ $other->no_rekening }}</option>
                        @endforeach
                    </select>
                    @error('account_id')
            ...
            <div class="card-footer col-mb-3">
                ...
                <div class="float-right">
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirmation-modal"><i class="far fa-papper-plane"></i>
                        Submit
                    </button>
                </div>
